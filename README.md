...
- Use `bash scripts/apply-netcore-n30pro.sh` to run the script. This avoids executable-permission problems when the script was created or edited from the GitHub web UI.
